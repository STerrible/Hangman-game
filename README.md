...
* Тестовый (не интерактивный) режим предназначен для тестирования программы методом "черного ящика" и должен
  использовать тот же движок игры, что и интерактивный режим. Внешние тесты имитируют пользовательский ввод.
...
* Следует реализовать программу в виде "движка", содержащего логику игры,
  и интерфейсов для интерактивного и тестового режимов работы, использующих этот движок.
